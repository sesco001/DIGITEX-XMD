...
const BOT_NAME = "DIGITEX-XMD";
const DEFAULT_THUMBNAIL = "https://files.catbox.moe/g7qjxj.jpg";
...
const createContext = (userJid, options = {}) => ({
    contextInfo: {
        ...
        externalAdReply: {
            ...
            sourceUrl: options.sourceUrl || "https://wa.me/254748571920", // link to bot or business
